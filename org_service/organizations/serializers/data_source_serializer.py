...
from ..models.data_source_model import DataSourceConfig
from ..config.service_config import get_service_config, get_api_endpoint, validate_service_config
...
class DataSourceConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'auth_type',
            'scopes',
            # Deleted field for extraction status
            'organisation'
        ]
...
class UpdateDataSourceConfigSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DataSourceConfig
        fields = ["description", "client_id", "client_secret", "api_key", "scopes"] #deleted status
